      ...
      {items.map((item) => {
        ...
        return (
          <button
            ...
            className={cn(
              "relative flex items-center gap-1.5 pb-2.5 font-architect text-[28px] transition-colors",
          ...
          >
            ...
            {item.count != null && (
              <span className="relative z-[1] font-architect text-[22px] text-ink-muted/65">
                {item.count}
              </span>
            )}
          </button>
