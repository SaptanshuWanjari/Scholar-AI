...
export const Advanced: Story = {
  render: () => (
    <ContextMenu items={[
      ...
      { key: 'save', label: 'Save link as...' },
      { key: 'share', label: 'Share...' },
      { key: 'inspect', label: 'Inspect element', danger: true }
    ]}>
      <div className="flex h-40 w-full max-w-sm items-center justify-center rounded-md border border-dashed border-black/20 font-architect text-sm bg-ochre-soft">
        Right click me instead
      </div>
    </ContextMenu>
  )
};
