...
from scholarai.api import dependency_service, parsers
...
from scholarai.storage.models import DepConcept, PYQQuestion, QuestionPaper, TopicStat, Deck, Card
...
def _read_pdf_text(path: Path) -> str:
    ...
    import fitz
    from scholarai.ingest import ocr as ocr_mod
