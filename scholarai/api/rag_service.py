...
from scholarai.rag.graph import get_rag_app
...
def run_ask(
    ...
    if session_id:
        ...
        from scholarai.api.chat_service import get_session_detail
    ...
    from scholarai.api import trace_service
...
def _lookup_concepts(query: str, course: str | None = None) -> str:
    ...
    from scholarai.storage.models import Concept, ConceptEdge
...
def _do_warmup():
    ...
    from scholarai.storage import get_session
    from scholarai.storage.models import ChatMessage, get_cached_embedding, set_cached_embedding
