...
from scholarai.api.rag_service import run_ask, stream_ask
...
from scholarai.rag.prompts import _RECOMMEND_SYSTEM
...
async def generate_mindmap(req: GenerateMindmapRequest) -> MindmapOut:
    ...
    if result["grounded"] and result["content"].strip():
        from scholarai.storage import get_session
        from scholarai.storage.models import Mindmap
