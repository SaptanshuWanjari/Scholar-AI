...
from scholarai.api.schemas import SearchResultOut
from scholarai.storage.vectors import search, hybrid_search
...
def global_search(
    ...
    from scholarai.storage.models import Whiteboard, Deck, SavedQuiz, Diagram, Concept
    session = get_session()
