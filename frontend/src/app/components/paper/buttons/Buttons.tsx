...
import { PaperSheetBorder, type PaperSheetBorderProps } from "../foundation/PaperSheetBorder";
import { SketchBorder, type SketchBorderProps } from "../foundation/SketchBorder";
