...
export function SunDoodle({
  ...
  return (
    <svg viewBox="0 0 100 100" {...svgProps(size, className)}>
      ...
      <path
        d="M41 47 Q44 43 47 47 M53 47 Q56 43 59 47"
        stroke={color}
        strokeWidth={strokeWidth}
        strokeLinecap="round"
      />
      <path
        d="M43 56 Q50 64 58 56"
        stroke={color}
        strokeWidth={strokeWidth}
        strokeLinecap="round"
      />
...
export function SignpostDoodle({
  size = 30,
  color = "#3a3733",
  strokeWidth = 2,
  className,
  ...
  return (
    <svg viewBox="0 0 32 32" {...svgProps(size, className)}>
      ...
      />
      <path
        d="M6 9 L20 9 L23 12 L20 15 L6 15 Z"
        stroke={color}
        strokeWidth={strokeWidth}
        strokeLinejoin="round"
      />
      <path
        d="M26 17 L12 17 L9 20 L12 23 L26 23 Z"
        stroke={color}
        strokeWidth={strokeWidth}
        strokeLinejoin="round"
      />
...
export function StarDoodleFilled({
  size = 20,
  color = "#c9954f",
  className,
}: DoodleProps) {
...
export function BookmarkDoodle({
  size = 20,
  color = "currentColor",
  strokeWidth = 1.8,
  className,
...
export function PaperPlaneDoodle({
  ...
  return (
    <svg viewBox="0 0 24 24" {...svgProps(size, className)}>
      ...
      <path d="M16 12 L3 12" stroke={color} strokeWidth={strokeWidth} />

      <path
        d="M3 12 Q6 10.5 8.5 9"
        stroke={color}
